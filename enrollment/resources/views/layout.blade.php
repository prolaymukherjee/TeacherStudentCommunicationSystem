...
<div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="text-center navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="{{URL::to('/dashboard')}}"><img src="Diu Reg Admin" alt="Student's Care"></a>
        </div>
                    ...
                    <div class="dropdown-menu navbar-dropdown notification-drop-down"
                       ...
                       <a class="dropdown-item" href="#">
                        ...
                        <a class="dropdown-item" href="{{URL::to('/notification')}}">
                            ...
                            <span class="notification-text">Announcement For All Student</span>
                        </a>
                    </div>
                </li>
    ...
    <div class="container-fluid page-body-wrapper">
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="user-info">
                    <div class="profile">
                         <img src="{{URL::to($teacher_info->teacher_image)}}"  style="height: 47px;width: 47px">
                    </div>
                    <div class="details">
                        <p class="user-name">{{$teacher_info->teacher_Name}}</p>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#layoutsSubmenu" aria-expanded="false"
                           aria-controls="layoutsSubmenu">
                            ...
                            <span class="menu-title">Make Counselling</span>
                            <i class="mdi mdi-chevron-down menu-arrow"></i>
                        </a>
                        <div class="collapse" id="layoutsSubmenu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{URL::to('/addCouncling')}}">Add Counselling</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#sidebar_layouts" aria-expanded="false"
                           aria-controls="sidebar_layouts">
                            <i class="mdi mdi-format-list-bulleted menu-icon"></i>
                            <span class="menu-title">Arrange Meeting</span>
                            <i class="mdi mdi-chevron-down menu-arrow"></i>
                        </a>
                        <div class="collapse" id="sidebar_layouts">
                            <ul class="nav flex-column sub-menu">
